...
<div class="wrapper">
	...
	<section class="history history-matches"> 
		<?php
		...
		<article>
		<ul>
			<li><p>ИГРА: <a>#'.$row["id"].'</a> <span>(посмотреть полную историю игры)</span></p></li>
			<li><p>ПОБЕДИЛ ИГРОК: <a>'.$winnername.'</a> <span>(с шансом в '.round($winnerpercent,1).'%)</span></p></li>
			<li><p>ВЫИГРЫШ: <a>'.round($winnercost,2).'<span class="ezpz-price" style="color: #db073d;"></span></a></p></li>
		</ul>
		<span class="winning">выигрыш отправлен</span>
		<div class="stuff" style="float: none; padding: 5px; width: 100%">';
				...
				<div style="float: left;">
					<a href="#">
						<img src="http://steamcommunity-a.akamaihd.net/economy/image/'.$row2["image"].'/60fx60f" title="'.$row2["item"].' - $'.$row2["value"].'" width="60" height="60">
					</a>
				</div>';
				}
			echo '
