...
================================================== */
	...
	oTable = $('.datatable table').dataTable({
		...
		"oLanguage": {
			...
			"sLengthMenu": "<span>Показать записи:</span> _MENU_",
			"oPaginate": { "sFirst": "Первый", "sLast": "Последний", "sNext": ">", "sPrevious": "<" }
		}
    });
	...
	$('.dataTables_filter input[type=text]').attr('placeholder','Введите для поиска ...');
